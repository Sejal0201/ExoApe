    ...
    <div className="w-full relative">
      <div className="max-w-screen-2xl mx-auto py-20 px-5 sm:px-10">
        <div className="featured flex gap-3">
          ...
          <h3 className="capitalize">featured project</h3>
        </div>
        ...
        <div className="elem sm:flex sm:flex-wrap sm:gap-5 mt-10">
          {elems.map((item, index) => {
            return (
              <div key={index} className="elem  w-full sm:w-[48%] mt-10">
                <div className="video w-full h-[100vw] sm:h-[50vw] relative overflow-hidden ">
                  <motion.img
                  initial={{opacity:1}}
